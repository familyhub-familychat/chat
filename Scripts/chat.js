...
function SendMsg(){ 
        ...
        ${document.getElementById('text').value }
           <span class="receivedTime ">1:28</span> 
        </p>
        </div>
        <div class="col-2 col-sm-1 col-md-1 mr-4">
            <img src="images/profilepic.png" class="chatimg" />
        </div>
    </div> `;
        document.getElementById('inputmessage').innerHTML += message;
        document.getElementById('text').value = '';
        document.getElementById('text').focus();
        
        document.getElementById('inputmessage').scrollTo(0, document.getElementById('inputmessage').clientHeight)
